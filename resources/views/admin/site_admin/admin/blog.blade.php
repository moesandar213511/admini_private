                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="name" required rows="1"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="text
                                            "><b>Text</b></label><br>
                                        <textarea rows="8" class="form-control" id="text" required></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="update_text
                                            "><b>Text</b></label><br>
                                        <textarea rows="8" class="form-control" id="update_text" required></textarea>
                                    </div>
                                </div>
                            </div>
