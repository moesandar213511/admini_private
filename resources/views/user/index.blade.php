            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('user/images/cat1.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('user/images/cat2.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('user/images/cat3.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('user/images/cat4.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-lg-0">
                        <img src="{{ asset('user/images/cat5.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-lg-0">
                        <img src="{{ asset('user/images/cat6.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-md-0">
                        <img src="{{ asset('user/images/cat7.png
                      ') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center">
                        <img src="{{ asset('user/images/cat8.png
                      ') }}" alt="category">
